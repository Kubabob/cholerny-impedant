...
class CircuitModel(CustomCircuit):
    def __init__(self, circuit):
        super().__init__()

    def _draw_parallel_elements(self, drawing, elements, start_pos=(0, 0), direction='right', spacing=1, labels=None) -> schemdraw.Drawing:
        """
    ...
    def draw_circuit(self, start_pos=(0, 0), direction='right', spacing=1) -> schemdraw.Drawing:
        """
        ...
        for i, part in enumerate(parts):
            ...
            if part.startswith('p(') and part.endswith(')'):
                ...
                if elements:
                    drawing = self._draw_parallel_elements(
                        drawing=drawing,
                        elements=elements,
...
#     circuit = CircuitModel("R0-p(C1, R1)")
#     drawed_circuit = circuit.draw_circuit()
#     drawed_circuit.draw()
